...
---
# 1 sources
 <iframe width="280" height="120" src="https://www.youtube.com/embed/tiEB69xGDfw" title="How To Setup Sublime text 4 for competitive programming like a pro 🔥🔥 || Change Sublime Text Theme 😱" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>

superbe set up pout cp 

## TERMINUS

<iframe width="280" height="220" src="https://www.youtube.com/embed/5TbGuPyZvA8" title="Sublime Text 4 Install &amp; Configure Integrated Terminal" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
...
[
    ...
    {
        "keys": ["ctrl+alt+b"], "command": "terminus_open", "args": {
...
utilise:
<iframe width="199" height="191" src="https://www.youtube.com/embed/tiEB69xGDfw" title="How To Setup Sublime text 4 for competitive programming like a pro 🔥🔥 || Change Sublime Text Theme 😱" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>

![](Screenshot%20from%202024-01-29%2022-30-53.png)

j'ai eu un probleme pour run build par defaut il m'a fallu utiliser  gcc dans le terminal puis placer le buid sur defaut 
<iframe width="175" height="157" src="https://www.youtube.com/embed/5Usw4MgIc04" title="How to Run C/C++ Application Using Sublime Text 4" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
...
2.     "color_scheme": "Packages/Agila Theme/Agila Neon Monocyanide.tmTheme",
    
3.     "darkmatter_sidebar_font_large": true,
    
4.     "darkmatter_sidebar_tree_large": true,
    
5.     "darkmatter_tabs_auto_width": true,
    
6.     "darkmatter_tabs_font_normal": true,
    
7.     "darkmatter_tabs_large": true,
...
13.     "save_on_focus_lost": true,
    
14.     "theme": "Darkmatter.sublime-theme"
